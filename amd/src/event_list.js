 ...
 * given day range.
 *
 * @module     block_course_activities/event_list
...
function(
    ...
    var TEMPLATES = {
        EVENT_LIST_CONTENT: 'block_course_activities/event-list-content'
    };
    ...
    var DEFAULT_PAGED_CONTENT_CONFIG = {
        ...
        ariaLabels: {
            itemsperpagecomponents: 'ariaeventlistpagelimit, block_course_activities',
        }
    };
