...
/**
 * Manage the course activities dates view for the course activities block.
 *
...
function(
     ...
     *
     * @param {object} root The root element for the course activities dates view.
    ...
    /**
     * Setup the listeners for the course activities block
     *
    ...
    var load = function(root) {
        ...
        var namespace = $(eventListContainer).attr('id') + "user_block_course_activities" + Math.random();
        registerEventListeners(root, namespace);

        var limits = getPagingLimits(root);
        var config = {
            persistentLimitKey: "block_course_activities_user_limit_preference",
            eventNamespace: namespace
        };
        Str.get_string('ariaeventlistpaginationnavdates', 'block_course_activities')
    ...
    /**
     * Initialise the course activities dates view. Begin loading the events
